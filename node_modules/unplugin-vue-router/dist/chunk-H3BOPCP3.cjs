...
var _chunkFASJJ6S2cjs = require('./chunk-FASJJ6S2.cjs');
...
var _TreeNodeValueBase = (_class = class {
  ...
  get path() {
    ...
    return (!parentPath || parentPath === "/") && pathSegment === "" ? "/" : _chunkFASJJ6S2cjs.joinPath.call(void 0, parentPath || "", pathSegment);
  }
  toString() {
  ...
  get overrides() {
    return [...this._overrides.entries()].sort(
      ...
      return _chunkFASJJ6S2cjs.mergeRouteRecordOverride.call(void 0, acc, routeBlock);
    }, {});
  }
  ...
  mergeOverride(filePath, routeBlock) {
    ...
    this._overrides.set(
      filePath,
      _chunkFASJJ6S2cjs.mergeRouteRecordOverride.call(void 0, existing, routeBlock)
    );
  }
  /**
...
function getRouteBlock(path, content, options) {
  ...
  if (result) {
    if (result.path != null && !result.path.startsWith("/")) {
      _chunkFASJJ6S2cjs.warn.call(void 0, `Overridden path must start with "/". Found in "${path}".`);
    }
  }
  return result;
}
function parseCustomBlock(block, filePath, options) {
  ...
  if (lang === "json5") {
    try {
      ...
      _chunkFASJJ6S2cjs.warn.call(void 0, 
...
var RoutesFolderWatcher = class {
  ...
  on(event, handler) {
    this.watcher.on(event, (filePath) => {
      ...
      handler({
        filePath,
        routePath: _chunkFASJJ6S2cjs.asRoutePath.call(void 0, 
          {
            src: this.src,
            path: this.path,
...
function resolveFolderOptions(globalOptions, folderOptions) {
  ...
  return {
    ...
    pattern: _chunkFASJJ6S2cjs.appendExtensionListToPattern.call(void 0, 
      filePatterns,
    ...
    if (prop.type === "ObjectProperty" && prop.key.type === "Identifier") {
      if (prop.key.name === "name") {
        if (prop.value.type !== "StringLiteral") {
          _chunkFASJJ6S2cjs.warn.call(void 0, `route name must be a string literal. Found in "${id}".`);
        } else {
          routeInfo.name = prop.value.value;
        }
      } else if (prop.key.name === "path") {
        if (prop.value.type !== "StringLiteral") {
          _chunkFASJJ6S2cjs.warn.call(void 0, `route path must be a string literal. Found in "${id}".`);
        } else {
...
function createRoutesContext(options) {
        ...
        return _fastglob2.default.call(void 0, folder.pattern, {
          ...
          (files) => Promise.all(
            files.map((file) => _pathe.resolve.call(void 0, folder.src, file)).map(
              (file) => addPage({
                routePath: _chunkFASJJ6S2cjs.asRoutePath.call(void 0, folder, file),
                filePath: file
              })
            )
          )
  ...
  function generateRoutes() {
    const importsMap = new (0, _chunkFASJJ6S2cjs.ImportsMap)();
...
`;
  ...
  async function _writeConfigFiles() {
    ...
    _chunkFASJJ6S2cjs.logTree.call(void 0, routeTree, logger.log);
    if (dts) {
  ...
  const writeConfigFiles = _chunkFASJJ6S2cjs.throttle.call(void 0, _writeConfigFiles, 500, 100);
...
var ignoredSpecifiers = ["vue", "vue-router", "pinia"];
function extractLoadersToExport(code) {
  ...
  const importNames = imports.flatMap((i) => {
    ...
    if (
      ...
      parsed.specifier.startsWith("@vueuse/") && ignoredSpecifiers.includes(parsed.specifier)
    )
      return [];
    return [
...
function createAutoExportPlugin() {
  const filterVueComponents = _pluginutils.createFilter.call(void 0, 
    [/\.vue$/, /\.vue\?vue/, /\.vue\?v=/]
...
var src_default = _unplugin.createUnplugin.call(void 0, (opt = {}, _meta) => {
  const options = _chunkFASJJ6S2cjs.resolveOptions.call(void 0, opt);
  ...
  const pageFilePattern = _chunkFASJJ6S2cjs.appendExtensionListToPattern.call(void 0, 
    options.filePatterns,
    _chunkFASJJ6S2cjs.mergeAllExtensions.call(void 0, options)
  );
